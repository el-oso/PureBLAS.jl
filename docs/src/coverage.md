...
|---|---|---|---|
| `asum` | 🐰 1.36 | 🐢 1.0 n=300000 | 🐢 0.97 n=10000 |
| `axpy` | 🐢 0.99 n=300000 | 🐢 0.99 n=1000000 | 🐢 0.98 n=1000000 |
| `dot` | 🐢 0.99 n=300000 | 🐢 0.99 n=1000000 | 🐢 0.96 n=300000 |
| `dzasum` | 🐰 1.29 | 🐰 1.0 | 🐢 1.0 n=30000 |
| `dznrm2` | 🐰 1.87 | 🐰 1.67 | 🐰 1.63 |
| `iamax` | 🐰 1.01 | 🐰 1.01 | 🐰 1.0 |
| `izamax` | 🐰 1.17 | 🐰 1.64 | 🐰 1.7 |
| `nrm2` | 🐰 1.95 | 🐰 2.0 | 🐰 1.93 |
| `scal` | 🐢 0.99 n=1000000 | 🐢 0.99 n=30000 | 🐢 0.98 n=1000000 |
| `zaxpy` | 🐢 0.98 n=10000 | 🐢 0.95 n=100000 | 🐢 0.87 n=10000 |
| `zdotc` | 🐢 1.0 n=300000 | 🐰 1.0 | 🐢 0.88 n=300000 |
| `zdotu` | 🐰 1.0 | 🐰 1.0 | 🐢 0.86 n=300000 |
| `zscal` | 🐢 0.99 n=300000 | 🐢 1.0 n=300000 | 🐢 0.97 n=1000000 |
...
| `sbmv` | 🐰 1.34 | 🐰 1.1 | 🐰 1.11 |
| `spmv` | 🐰 1.93 | 🐰 1.77 | 🐰 1.74 |
| `symv` | 🐢 0.98 n=4096 | 🐢 0.95 n=2048 | 🐰 1.06 |
| `trmv` | 🐢 0.98 n=4096 | 🐢 0.99 n=4096 | 🐢 0.86 n=128 |
| `trsv` | 🐰 1.02 | 🐢 0.97 n=4096 | 🐰 1.0 |
| `zgbmvN` | 🐰 1.3 | 🐰 1.22 | 🐰 1.05 |
| `zgemvC` | 🐢 0.96 n=1024 | 🐢 0.91 n=1024 | 🐢 0.93 n=1024 |
| `zgemvN` | 🐢 0.99 n=4096 | 🐢 0.88 n=1024 | 🐢 0.96 n=1024 |
| `zgemvT` | 🐢 0.96 n=1024 | 🐢 0.92 n=1024 | 🐢 0.93 n=1024 |
| `zgeru` | 🐢 0.97 n=1024 | 🐢 0.84 n=1024 | 🐢 0.92 n=4096 |
| `zhbmv` | 🐰 1.35 | 🐰 1.05 | 🐰 1.05 |
| `zhemv` | 🐢 0.92 n=2048 | 🐰 1.24 | 🐰 1.39 |
| `zhpmv` | 🐰 1.29 | 🐰 1.12 | 🐰 1.11 |
| `ztrmv` | 🐰 1.05 | 🐰 1.03 | 🐰 1.06 |
| `ztrsv` | 🐰 1.02 | 🐰 1.03 | 🐢 0.94 n=1024 |

#### BLAS-3

| routine | Zen3 · AVX2 | Zen4 · AVX-512 | Zen5 · AVX-512 |
|---|---|---|---|
| `gemm` | 🐢 0.97 n=128 | 🐢 0.97 n=128 | 🐢 0.99 n=256 |
...
| `gtsv` | 🐰 1.2 | 🐰 1.21 | 🐰 1.2 |
| `gttrf` | 🐰 1.52 | 🐰 1.45 | 🐰 1.51 |
| `gttrs` | 🐢 1.0 n=65536 | 🐰 1.0 | 🐢 1.0 n=4096 |
| `pbtrfL` | 🐢 0.98 n=192 | 🐰 1.11 | 🐰 1.06 |
| `pbtrfU` | 🐢 0.87 n=128 | 🐰 1.03 | 🐢 0.97 n=256 |
| `potrf` | 🐰 1.04 | 🐰 1.08 | 🐢 0.98 n=2048 |
| `potrfU` | 🐢 0.83 n=8 | 🐢 0.83 n=8 | 🐢 0.86 n=8 |
| `potrsL` | 🐢 0.95 n=1024 | 🐢 0.91 n=256 | 🐢 0.88 n=512 |
| `potrsU` | 🐢 0.99 n=512 | 🐢 0.99 n=2048 | 🐰 1.04 |
| `pptrfL` | 🐰 1.0 | 🐢 0.91 n=32 | 🐰 1.01 |
| `pptrfU` | 🐰 1.03 | 🐢 0.92 n=128 | 🐢 0.93 n=128 |
| `pstrf` | 🐰 1.02 | 🐢 0.99 n=8 | 🐢 0.85 n=8 |
| `pstrfU` | 🐰 1.01 | 🐢 0.99 n=32 | 🐢 0.94 n=8 |
| `ptsv` | 🐰 1.05 | 🐰 1.05 | 🐰 1.03 |
...
| `sytrf` | 🐰 1.07 | 🐰 1.0 | 🐰 1.06 |
| `sytrs` | 🐰 1.48 | 🐰 1.34 | 🐰 1.36 |
| `trtrs` | 🐰 1.04 | 🐢 0.75 n=2048 | 🐢 0.99 n=2048 |
