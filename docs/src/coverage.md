...
| routine | gate | worst cell | geomean | sizes |
|---|---|---|---|---|
| `gemm` | 🐢 0.97 | n=128 | 1.09 | 16 |
| `symm` | 🐢 0.9 | n=256 | 1.04 | 16 |
| `syr2k` | 🐢 0.96 | n=4096 | 1.08 | 16 |
| `syrk` | 🐢 0.94 | n=4096 | 1.05 | 16 |
| `trmm` | 🐢 0.85 | n=8 | 1.0 | 16 |
| `trsm` | 🐢 0.92 | n=32 | 1.01 | 16 |
...
| `ztrsm` | 🐢 0.65 | n=128 | 0.93 | 14 |
| `ztrsmR` | 🐢 0.93 | n=128 | 1.12 | 14 |

#### LAPACK

| routine | gate | worst cell | geomean | sizes |
|---|---|---|---|---|
| `gbtrf` | 🐢 0.72 | n=128 | 1.2 | 14 |
| `gels` | 🐰 1.28 | n=32 | 1.87 | 12 |
| `geqp3` | 🐰 1.03 | n=2048 | 1.23 | 14 |
| `geqrf` | 🐢 0.95 | n=32 | 1.49 | 16 |
| `gesvd` | 🐰 1.05 | n=32 | 1.21 | 14 |
| `getrf` | 🐢 0.95 | n=32 | 1.17 | 16 |
| `getrs` | 🐢 0.85 | n=8 | 1.06 | 14 |
| `gtsv` | 🐰 1.2 | n=262144 | 1.26 | 12 |
| `gttrf` | 🐰 1.25 | n=16384 | 1.57 | 12 |
| `gttrs` | 🐢 1.0 | n=262144 | 1.0 | 12 |
| `pbtrfL` | 🐢 1.0 | n=192 | 1.27 | 16 |
| `pbtrfU` | 🐢 0.87 | n=192 | 1.2 | 16 |
| `potrf` | 🐰 1.03 | n=4096 | 1.32 | 16 |
| `potrfU` | 🐢 0.83 | n=8 | 1.17 | 16 |
| `potrsL` | 🐢 0.91 | n=256 | 1.02 | 14 |
| `potrsU` | 🐢 0.97 | n=2048 | 1.21 | 14 |
| `pptrfL` | 🐢 0.93 | n=32 | 1.06 | 14 |
| `pptrfU` | 🐢 0.92 | n=128 | 1.14 | 14 |
| `pstrf` | 🐢 1.0 | n=8 | 1.25 | 16 |
| `pstrfU` | 🐰 1.02 | n=32 | 1.29 | 16 |
| `ptsv` | 🐰 1.05 | n=256 | 1.07 | 12 |
| `pttrf` | 🐰 1.11 | n=256 | 1.12 | 12 |
| `pttrs` | 🐢 0.99 | n=256 | 1.0 | 12 |
| `syev` | 🐰 1.19 | n=2048 | 1.31 | 14 |
| `syevN` | 🐢 0.99 | n=1024 | 1.13 | 14 |
| `sytrf` | 🐰 1.06 | n=4096 | 1.34 | 16 |
| `sytrs` | 🐰 1.28 | n=2048 | 1.68 | 14 |
| `trtrs` | 🐰 1.03 | n=256 | 1.16 | 14 |
...
triangular** is the largest: `ztrsm` 0.65, `ztrmmR` 0.78, `zgemm` 0.81, `ztrmm` 0.82, `zsymm`/`zhemm`
~0.90 — all worst at n=32/128 and all recovering by n≥512, i.e. one shared cause rather than six kernel
problems. **Complex gemv** is the second: `zgemvN`/`zgemvC`/`zgemvT`/`zgeru`/`zhemv` all 0.88–0.93 and all
worst at n=1024–2048, which is the same lever the gesvd campaign identified. Everything real in BLAS-1/2
is within 6% of the faster vendor, and banded/packed gates outright (`spmv` 1.76, `zhpmv` 1.12,
