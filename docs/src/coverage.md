...
|---|---|---|---|---|
| `asum` | 🐢 0.97 | n=10000 | 1.06 | 21 |
| `axpy` | 🐢 0.97 | n=1000000 | 1.0 | 21 |
| `dot` | 🐢 0.96 | n=300000 | 1.0 | 21 |
| `dzasum` | 🐢 1.0 | n=30000 | 1.03 | 21 |
| `dznrm2` | 🐰 1.6 | n=1000000 | 2.52 | 21 |
| `iamax` | 🐢 0.97 | n=1000000 | 1.03 | 21 |
| `izamax` | 🐰 1.15 | n=3000 | 1.66 | 21 |
| `nrm2` | 🐰 1.92 | n=1000000 | 2.56 | 21 |
| `scal` | 🐢 0.97 | n=1000000 | 1.0 | 21 |
| `zaxpy` | 🐢 0.86 | n=10000 | 1.0 | 21 |
| `zdotc` | 🐢 0.87 | n=300000 | 1.01 | 21 |
| `zdotu` | 🐢 0.84 | n=300000 | 1.01 | 21 |
| `zscal` | 🐢 0.96 | n=1000000 | 0.99 | 21 |

#### BLAS-2

| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `gbmvN` | 🐰 1.06 | n=4096 | 1.23 | 21 |
| `gemvN` | 🐢 0.94 | n=1024 | 1.04 | 21 |
| `gemvT` | 🐢 0.8 | n=256 | 1.03 | 21 |
| `ger` | 🐢 0.96 | n=4096 | 1.05 | 21 |
| `sbmv` | 🐰 1.08 | n=256 | 1.13 | 21 |
| `spmv` | 🐰 1.73 | n=64 | 2.01 | 21 |
| `symv` | 🐢 0.95 | n=2048 | 1.12 | 21 |
| `trmv` | 🐢 0.86 | n=128 | 1.02 | 21 |
| `trsv` | 🐢 0.97 | n=4096 | 1.04 | 21 |
| `zgbmvN` | 🐰 1.05 | n=4096 | 1.26 | 21 |
| `zgemvC` | 🐢 0.91 | n=1024 | 1.02 | 21 |
| `zgemvN` | 🐢 0.88 | n=1024 | 1.02 | 21 |
| `zgemvT` | 🐢 0.92 | n=1024 | 1.01 | 21 |
| `zgeru` | 🐢 0.84 | n=1024 | 1.01 | 21 |
| `zhbmv` | 🐰 1.05 | n=4096 | 1.07 | 21 |
| `zhemv` | 🐢 0.92 | n=2048 | 1.88 | 21 |
| `zhpmv` | 🐰 1.11 | n=4096 | 1.42 | 21 |
| `ztrmv` | 🐰 1.02 | n=1024 | 1.2 | 21 |
| `ztrsv` | 🐢 0.94 | n=1024 | 1.12 | 21 |

#### BLAS-3

| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `gemm` | 🐢 0.97 | n=128 | 1.05 | 24 |
| `symm` | 🐢 0.93 | n=256 | 1.0 | 24 |
| `syr2k` | 🐢 0.93 | n=128 | 1.03 | 24 |
| `syrk` | 🐢 0.94 | n=4096 | 1.01 | 24 |
| `trmm` | 🐢 0.89 | n=256 | 0.99 | 24 |
| `trsm` | 🐢 0.91 | n=32 | 1.02 | 24 |
| `trsmR` | 🐢 0.8 | n=128 | 0.99 | 24 |
| `zgemm` | 🐢 0.8 | n=32 | 1.02 | 21 |
| `zhemm` | 🐢 0.9 | n=32 | 1.01 | 21 |
| `zher2k` | 🐢 0.91 | n=32 | 1.01 | 21 |
| `zherk` | 🐢 0.98 | n=1024 | 1.05 | 21 |
| `zsymm` | 🐢 0.89 | n=32 | 1.01 | 21 |
| `zsyr2k` | 🐢 0.91 | n=32 | 0.99 | 21 |
| `zsyrk` | 🐢 0.94 | n=128 | 0.99 | 21 |
| `ztrmm` | 🐢 0.82 | n=32 | 0.98 | 21 |
| `ztrmmR` | 🐢 0.78 | n=32 | 1.0 | 21 |
| `ztrsm` | 🐢 0.98 | n=128 | 1.12 | 21 |
| `ztrsmR` | 🐢 0.79 | n=128 | 0.99 | 21 |

#### LAPACK

| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `gbtrf` | 🐢 0.71 | n=128 | 1.11 | 21 |
| `gels` | 🐰 1.26 | n=32 | 1.8 | 18 |
| `geqp3` | 🐰 1.02 | n=2048 | 1.2 | 21 |
| `geqrf` | 🐢 0.96 | n=32 | 1.46 | 24 |
| `gesvd` | 🐰 1.04 | n=2048 | 1.16 | 21 |
| `getrf` | 🐢 0.96 | n=32 | 1.18 | 24 |
| `getrs` | 🐢 0.81 | n=8 | 1.05 | 21 |
| `gtsv` | 🐰 1.2 | n=262144 | 1.29 | 18 |
| `gttrf` | 🐰 1.44 | n=256 | 1.6 | 18 |
| `gttrs` | 🐢 1.0 | n=4096 | 1.0 | 18 |
| `pbtrfL` | 🐢 0.98 | n=192 | 1.17 | 24 |
| `pbtrfU` | 🐢 0.87 | n=128 | 1.1 | 24 |
| `potrf` | 🐢 0.98 | n=2048 | 1.26 | 24 |
| `potrfU` | 🐢 0.82 | n=8 | 1.15 | 24 |
| `potrsL` | 🐢 0.88 | n=512 | 0.98 | 21 |
| `potrsU` | 🐢 0.99 | n=2048 | 1.15 | 21 |
| `pptrfL` | 🐢 0.91 | n=32 | 1.04 | 21 |
| `pptrfU` | 🐢 0.92 | n=128 | 1.03 | 21 |
| `pstrf` | 🐢 0.84 | n=8 | 1.22 | 24 |
| `pstrfU` | 🐢 0.94 | n=32 | 1.24 | 24 |
| `ptsv` | 🐰 1.03 | n=256 | 1.07 | 18 |
| `pttrf` | 🐰 1.09 | n=256 | 1.12 | 18 |
| `pttrs` | 🐢 0.99 | n=256 | 1.0 | 18 |
| `syev` | 🐰 1.09 | n=8 | 1.28 | 21 |
| `syevN` | 🐢 0.98 | n=1024 | 1.13 | 21 |
| `sytrf` | 🐰 1.0 | n=2048 | 1.2 | 24 |
| `sytrs` | 🐰 1.32 | n=2048 | 1.61 | 21 |
| `trtrs` | 🐢 0.74 | n=2048 | 1.08 | 21 |
| `zgeqrf` | 🐢 0.97 | n=1024 | 1.19 | 21 |
| `zgesvd` | 🐢 0.99 | n=32 | 1.18 | 21 |
| `zgetrf` | 🐢 0.95 | n=32 | 1.12 | 21 |
| `zheev` | 🐰 1.05 | n=256 | 1.23 | 21 |
| `zheevN` | 🐢 0.98 | n=32 | 1.34 | 21 |
| `zpotrf` | 🐢 1.0 | n=2048 | 1.11 | 21 |
| `zpotrfU` | 🐢 0.61 | n=8 | 1.0 | 21 |
