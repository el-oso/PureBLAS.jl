...
`geomean` is over that routine's cells; `sizes` is how many (op, size, box) cells back the row.
Generated by `bench/coverage_ops.jl` from the caches, not transcribed.

#### BLAS-1

| routine | gate | worst cell | geomean | sizes |
|---|---|---|---|---|
| `asum` | 🐢 1.0 | n=1000000 | 1.29 | 14 |
| `axpy` | 🐢 0.98 | n=1000000 | 1.01 | 14 |
| `dot` | 🐢 0.99 | n=100000 | 1.01 | 14 |
| `dzasum` | 🐢 0.97 | n=1000 | 1.19 | 14 |
| `dznrm2` | 🐰 1.67 | n=1000000 | 2.31 | 14 |
| `iamax` | 🐢 0.96 | n=10000 | 1.05 | 14 |
| `izamax` | 🐰 1.14 | n=100000 | 1.36 | 14 |
| `nrm2` | 🐰 1.88 | n=1000000 | 2.56 | 14 |
| `scal` | 🐢 0.98 | n=300000 | 1.01 | 14 |
| `zaxpy` | 🐢 0.97 | n=1000000 | 1.01 | 14 |
| `zdotc` | 🐢 0.95 | n=1000 | 1.0 | 14 |
| `zdotu` | 🐢 0.98 | n=1000 | 1.01 | 14 |
| `zscal` | 🐢 0.97 | n=1000000 | 1.01 | 14 |

#### BLAS-2

| routine | gate | worst cell | geomean | sizes |
|---|---|---|---|---|
| `gbmvN` | 🐰 1.06 | n=4096 | 1.26 | 14 |
| `gemvN` | 🐢 0.96 | n=4096 | 1.09 | 14 |
| `gemvT` | 🐢 0.97 | n=2048 | 1.05 | 14 |
| `ger` | 🐰 1.01 | n=512 | 1.13 | 14 |
| `sbmv` | 🐰 1.1 | n=4096 | 1.23 | 14 |
| `spmv` | 🐰 1.76 | n=64 | 2.15 | 14 |
| `symv` | 🐢 0.95 | n=2048 | 1.13 | 14 |
| `trmv` | 🐢 0.96 | n=256 | 1.08 | 14 |
| `trsv` | 🐢 0.97 | n=4096 | 1.1 | 14 |
| `zgbmvN` | 🐰 1.22 | n=2048 | 1.39 | 14 |
| `zgemvC` | 🐢 0.91 | n=1024 | 1.03 | 14 |
| `zgemvN` | 🐢 0.88 | n=1024 | 1.03 | 14 |
| `zgemvT` | 🐢 0.92 | n=1024 | 1.01 | 14 |
| `zgeru` | 🐢 0.84 | n=1024 | 1.04 | 14 |
| `zhbmv` | 🐰 1.05 | n=1024 | 1.2 | 14 |
| `zhemv` | 🐢 0.93 | n=2048 | 1.39 | 14 |
| `zhpmv` | 🐰 1.12 | n=4096 | 1.42 | 14 |
| `ztrmv` | 🐰 1.02 | n=1024 | 1.27 | 14 |
| `ztrsv` | 🐰 1.02 | n=1024 | 1.17 | 14 |

#### BLAS-3

| routine | gate | worst cell | geomean | sizes |
|---|---|---|---|---|
| `gemm` | 🐢 0.97 | n=128 | 1.1 | 16 |
| `symm` | 🐢 0.9 | n=256 | 1.05 | 16 |
| `syr2k` | 🐢 0.96 | n=4096 | 1.08 | 16 |
| `syrk` | 🐢 0.94 | n=4096 | 1.07 | 16 |
| `trmm` | 🐢 0.9 | n=256 | 1.04 | 16 |
| `trsm` | 🐢 0.91 | n=32 | 1.01 | 16 |
| `trsmR` | 🐢 0.8 | n=128 | 1.08 | 16 |
| `zgemm` | 🐢 0.81 | n=32 | 1.15 | 14 |
| `zhemm` | 🐢 0.9 | n=32 | 1.09 | 14 |
| `zher2k` | 🐢 0.91 | n=32 | 1.06 | 14 |
| `zherk` | 🐢 0.98 | n=1024 | 1.13 | 14 |
| `zsymm` | 🐢 0.89 | n=32 | 1.08 | 14 |
| `zsyr2k` | 🐢 0.91 | n=32 | 1.05 | 14 |
| `zsyrk` | 🐢 0.94 | n=128 | 1.12 | 14 |
| `ztrmm` | 🐢 0.82 | n=32 | 1.0 | 14 |
| `ztrmmR` | 🐢 0.78 | n=32 | 1.03 | 14 |
| `ztrsm` | 🐰 1.03 | n=128 | 1.24 | 14 |
| `ztrsmR` | 🐢 0.93 | n=128 | 1.16 | 14 |

#### LAPACK

| routine | gate | worst cell | geomean | sizes |
|---|---|---|---|---|
| `gbtrf` | 🐢 0.72 | n=128 | 1.19 | 14 |
| `gels` | 🐰 1.29 | n=32 | 1.87 | 12 |
| `geqp3` | 🐰 1.02 | n=2048 | 1.24 | 14 |
| `geqrf` | 🐢 0.96 | n=32 | 1.5 | 16 |
| `gesvd` | 🐰 1.05 | n=2048 | 1.19 | 14 |
| `getrf` | 🐢 0.95 | n=32 | 1.17 | 16 |
| `getrs` | 🐢 0.85 | n=8 | 1.07 | 14 |
| `gtsv` | 🐰 1.2 | n=262144 | 1.26 | 12 |
| `gttrf` | 🐰 1.25 | n=16384 | 1.56 | 12 |
| `gttrs` | 🐢 1.0 | n=262144 | 1.0 | 12 |
| `pbtrfL` | 🐢 1.0 | n=192 | 1.27 | 16 |
| `pbtrfU` | 🐢 0.87 | n=192 | 1.2 | 16 |
| `potrf` | 🐰 1.03 | n=4096 | 1.33 | 16 |
| `potrfU` | 🐢 0.83 | n=8 | 1.17 | 16 |
| `potrsL` | 🐢 0.91 | n=256 | 1.02 | 14 |
| `potrsU` | 🐢 0.99 | n=2048 | 1.24 | 14 |
| `pptrfL` | 🐢 0.93 | n=32 | 1.05 | 14 |
| `pptrfU` | 🐢 0.93 | n=128 | 1.14 | 14 |
| `pstrf` | 🐢 0.65 | n=8 | 1.22 | 16 |
| `pstrfU` | 🐢 0.99 | n=32 | 1.3 | 16 |
| `ptsv` | 🐰 1.05 | n=256 | 1.07 | 12 |
| `pttrf` | 🐰 1.11 | n=256 | 1.12 | 12 |
| `pttrs` | 🐢 0.99 | n=256 | 1.0 | 12 |
| `syev` | 🐰 1.09 | n=8 | 1.29 | 14 |
| `syevN` | 🐢 0.98 | n=1024 | 1.13 | 14 |
| `sytrf` | 🐰 1.07 | n=4096 | 1.35 | 16 |
| `sytrs` | 🐰 1.32 | n=2048 | 1.68 | 14 |
| `trtrs` | 🐢 0.74 | n=2048 | 1.1 | 14 |
| `zgeqrf` | 🐰 1.05 | n=1024 | 1.29 | 14 |
| `zgesvd` | 🐢 0.99 | n=32 | 1.25 | 14 |
| `zgetrf` | 🐢 0.95 | n=32 | 1.11 | 14 |
| `zheev` | 🐰 1.08 | n=8 | 1.43 | 14 |
| `zheevN` | 🐢 0.98 | n=32 | 1.29 | 14 |
| `zpotrf` | 🐢 1.0 | n=2048 | 1.16 | 14 |
| `zpotrfU` | 🐢 0.61 | n=8 | 0.91 | 14 |
