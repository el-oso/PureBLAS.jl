...
| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `asum` | 🐢 0.99 | n=1000000 | 1.29 | 14 |
| `axpy` | 🐢 0.97 | n=1000000 | 1.0 | 14 |
| `dot` | 🐢 0.98 | n=1000000 | 1.0 | 14 |
| `dzasum` | 🐢 0.97 | n=1000 | 1.02 | 14 |
| `dznrm2` | 🐰 1.66 | n=1000000 | 2.29 | 14 |
| `iamax` | 🐢 0.94 | n=100000 | 1.01 | 14 |
| `izamax` | 🐰 1.09 | n=1000000 | 1.23 | 14 |
| `nrm2` | 🐰 1.83 | n=1000000 | 2.46 | 14 |
| `scal` | 🐢 0.99 | n=300000 | 1.0 | 14 |
| `zaxpy` | 🐢 0.97 | n=1000000 | 1.0 | 14 |
| `zdotc` | 🐢 1.0 | n=300000 | 1.01 | 14 |
| `zdotu` | 🐢 0.99 | n=1000000 | 1.0 | 14 |
| `zscal` | 🐢 0.98 | n=1000000 | 1.0 | 14 |

#### BLAS-2

| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `gbmvN` | 🐰 1.06 | n=4096 | 1.17 | 14 |
| `gemvN` | 🐢 0.96 | n=4096 | 1.03 | 14 |
| `gemvT` | 🐢 0.97 | n=2048 | 1.04 | 14 |
| `ger` | 🐢 0.95 | n=1024 | 1.09 | 14 |
| `sbmv` | 🐰 1.1 | n=4096 | 1.14 | 14 |
| `spmv` | 🐰 1.76 | n=64 | 2.01 | 14 |
| `symv` | 🐢 0.95 | n=2048 | 1.08 | 14 |
| `trmv` | 🐢 0.96 | n=256 | 1.01 | 14 |
| `trsv` | 🐢 0.97 | n=4096 | 1.03 | 14 |
| `zgbmvN` | 🐰 1.22 | n=2048 | 1.42 | 14 |
| `zgemvC` | 🐢 0.91 | n=1024 | 1.0 | 14 |
| `zgemvN` | 🐢 0.88 | n=1024 | 1.03 | 14 |
| `zgemvT` | 🐢 0.92 | n=1024 | 1.0 | 14 |
| `zgeru` | 🐢 0.84 | n=1024 | 1.01 | 14 |
| `zhbmv` | 🐰 1.05 | n=1024 | 1.09 | 14 |
| `zhemv` | 🐢 0.93 | n=2048 | 1.14 | 14 |
| `zhpmv` | 🐰 1.12 | n=4096 | 1.33 | 14 |
| `ztrmv` | 🐰 1.02 | n=1024 | 1.15 | 14 |
| `ztrsv` | 🐰 1.02 | n=1024 | 1.12 | 14 |

#### BLAS-3

| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `gemm` | 🐢 0.97 | n=128 | 1.05 | 16 |
| `symm` | 🐢 0.9 | n=256 | 0.97 | 16 |
| `syr2k` | 🐢 0.96 | n=4096 | 0.99 | 16 |
| `syrk` | 🐢 0.94 | n=4096 | 0.99 | 16 |
| `trmm` | 🐢 0.9 | n=256 | 0.97 | 16 |
| `trsm` | 🐢 0.91 | n=32 | 0.99 | 16 |
| `trsmR` | 🐢 0.8 | n=128 | 0.95 | 16 |
| `zgemm` | 🐢 0.81 | n=32 | 1.02 | 14 |
| `zhemm` | 🐢 0.9 | n=32 | 1.07 | 14 |
| `zher2k` | 🐢 0.91 | n=32 | 1.01 | 14 |
| `zherk` | 🐢 0.98 | n=1024 | 1.06 | 14 |
| `zsymm` | 🐢 0.89 | n=32 | 1.07 | 14 |
| `zsyr2k` | 🐢 0.91 | n=32 | 0.99 | 14 |
| `zsyrk` | 🐢 0.94 | n=128 | 1.04 | 14 |
| `ztrmm` | 🐢 0.82 | n=32 | 0.98 | 14 |
| `ztrmmR` | 🐢 0.78 | n=32 | 0.98 | 14 |
| `ztrsm` | 🐰 1.03 | n=128 | 1.13 | 14 |
| `ztrsmR` | 🐢 0.93 | n=128 | 1.02 | 14 |

#### LAPACK

| routine | gate | worst cell | median | sizes |
|---|---|---|---|---|
| `gbtrf` | 🐢 0.72 | n=128 | 1.1 | 14 |
| `gels` | 🐰 1.29 | n=32 | 1.78 | 12 |
| `geqp3` | 🐰 1.02 | n=2048 | 1.19 | 14 |
| `geqrf` | 🐢 0.96 | n=32 | 1.49 | 16 |
| `gesvd` | 🐰 1.05 | n=2048 | 1.17 | 14 |
| `getrf` | 🐢 0.95 | n=32 | 1.15 | 16 |
| `getrs` | 🐢 0.85 | n=8 | 1.03 | 14 |
| `gtsv` | 🐰 1.2 | n=262144 | 1.28 | 12 |
| `gttrf` | 🐰 1.25 | n=16384 | 1.6 | 12 |
| `gttrs` | 🐢 1.0 | n=262144 | 1.0 | 12 |
| `pbtrfL` | 🐢 1.0 | n=192 | 1.16 | 16 |
| `pbtrfU` | 🐢 0.87 | n=192 | 1.11 | 16 |
| `potrf` | 🐰 1.03 | n=4096 | 1.28 | 16 |
| `potrfU` | 🐢 0.83 | n=8 | 1.17 | 16 |
| `potrsL` | 🐢 0.91 | n=256 | 0.98 | 14 |
| `potrsU` | 🐢 0.99 | n=2048 | 1.15 | 14 |
| `pptrfL` | 🐢 0.93 | n=32 | 1.04 | 14 |
| `pptrfU` | 🐢 0.93 | n=128 | 1.08 | 14 |
| `pstrf` | 🐢 0.65 | n=8 | 1.21 | 16 |
| `pstrfU` | 🐢 0.99 | n=32 | 1.27 | 16 |
| `ptsv` | 🐰 1.05 | n=256 | 1.07 | 12 |
| `pttrf` | 🐰 1.11 | n=256 | 1.11 | 12 |
| `pttrs` | 🐢 0.99 | n=256 | 1.0 | 12 |
| `syev` | 🐰 1.09 | n=8 | 1.3 | 14 |
| `syevN` | 🐢 0.98 | n=1024 | 1.09 | 14 |
| `sytrf` | 🐰 1.07 | n=4096 | 1.22 | 16 |
| `sytrs` | 🐰 1.32 | n=2048 | 1.6 | 14 |
| `trtrs` | 🐢 0.74 | n=2048 | 1.06 | 14 |
| `zgeqrf` | 🐰 1.05 | n=1024 | 1.23 | 14 |
| `zgesvd` | 🐢 0.99 | n=32 | 1.17 | 14 |
| `zgetrf` | 🐢 0.95 | n=32 | 1.12 | 14 |
| `zheev` | 🐰 1.08 | n=8 | 1.36 | 14 |
| `zheevN` | 🐢 0.98 | n=32 | 1.22 | 14 |
| `zpotrf` | 🐢 1.0 | n=2048 | 1.07 | 14 |
| `zpotrfU` | 🐢 0.61 | n=8 | 1.0 | 14 |

**Reading the tables.** The misses cluster, and the clusters name the open work. **Small-`n` complex
triangular** is still the largest: `ztrmmR` 0.78, `zgemm` 0.81, `ztrmm` 0.82, `zsymm`/`zhemm` ~0.90 —
all worst at n=32 and all recovering by n≥512, i.e. one shared cause rather than five kernel problems.
`ztrsm` was the worst of that cluster at 0.65 and now gates at 1.03, which is evidence for the shared
cause: the fix was a complex `gemmtrsm` leaf with RHS columns in the lanes, not a `trsm`-specific one.
**Complex gemv** is the second: `zgemvN`/`zgemvC`/`zgemvT`/`zhemv` 0.88–0.93 and `zgeru` 0.84, all worst
at n=1024–2048, which is the same lever the gesvd campaign identified. Everything real in BLAS-1/2 is
within 4% of the faster vendor, and banded/packed gates outright (`spmv` 1.76, `zhpmv` 1.12,
`gbmvN`/`sbmv`/`zgbmvN`/`zhbmv` all 🐰).

Two rows moved for reasons unrelated to any kernel change, and are called out so they are not misread as
regressions introduced by the surrounding work. `trtrs` 0.74 at n=2048 is the pre-existing narrow-`B`
(nrhs=1) large-`n` `trsm` miss. `pstrf` 0.65 at n=8 is a tiny-`n` cell whose samples are scattered —
p90/min is 1.73 there against AOCL's 1.26, and the same cell on the AVX2 box lands at 1.59 with an
equally wide spread — so it is per-call-overhead noise at a size where a single call is microseconds,
not a 35% loss. Both predate the runs that produced this table.

A 🐢 at 0.99 and a 🐢 at 0.65 are not the same problem — that distinction is exactly what the old
four-row table destroyed, and why several routines that had quietly started gating (`ger`, `ztrmv`,
`ztrsv`, `geqp3`) were still being shown as failing groups.
...
!!! note "Provenance — BLAS re-measured in full 2026-08-01"
    Each row is over every size and box for that routine, pooled across the freq-locked fleet
    ...
    commit — not a subset merge — so no cell in the tables above predates the sweep. Rows are
    derived from the caches by `bench/coverage_ops.jl` rather than transcribed by eye.
