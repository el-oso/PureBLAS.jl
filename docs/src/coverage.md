...
|---|---|---|---|
| `asum` | 🐰 1.36 | 🐢 0.99 n=100000 | 🐢 0.97 n=10000 |
| `axpy` | 🐢 0.99 n=300000 | 🐢 0.98 n=1000000 | 🐢 0.97 n=1000000 |
| `dot` | 🐢 1.0 n=300000 | 🐢 0.99 n=1000000 | 🐢 0.96 n=300000 |
| `dzasum` | 🐰 1.27 | 🐢 1.0 n=1000000 | 🐢 1.0 n=30000 |
| `dznrm2` | 🐰 1.87 | 🐰 1.66 | 🐰 1.6 |
| `iamax` | 🐰 1.01 | 🐰 1.01 | 🐢 0.97 n=1000000 |
| `izamax` | 🐰 1.15 | 🐰 1.56 | 🐰 1.66 |
| `nrm2` | 🐰 1.92 | 🐰 2.0 | 🐰 1.93 |
| `scal` | 🐢 0.98 n=1000000 | 🐢 0.99 n=30000 | 🐢 0.97 n=1000000 |
| `zaxpy` | 🐢 0.98 n=10000 | 🐢 0.95 n=100000 | 🐢 0.86 n=10000 |
| `zdotc` | 🐢 1.0 n=300000 | 🐰 1.0 | 🐢 0.87 n=300000 |
| `zdotu` | 🐰 1.0 | 🐢 0.99 n=1000000 | 🐢 0.84 n=300000 |
| `zscal` | 🐢 0.99 n=300000 | 🐢 0.98 n=1000000 | 🐢 0.96 n=1000000 |
...
| `gemvN` | 🐢 0.96 n=4096 | 🐢 0.99 n=256 | 🐢 0.94 n=1024 |
| `gemvT` | 🐢 0.95 n=2048 | 🐢 0.97 n=256 | 🐢 0.8 n=256 |
| `ger` | 🐰 1.0 | 🐰 1.01 | 🐢 0.96 n=4096 |
| `sbmv` | 🐰 1.34 | 🐰 1.1 | 🐰 1.08 |
| `spmv` | 🐰 1.92 | 🐰 1.76 | 🐰 1.73 |
| `symv` | 🐢 0.98 n=4096 | 🐢 0.95 n=2048 | 🐰 1.05 |
| `trmv` | 🐢 0.98 n=4096 | 🐢 0.99 n=4096 | 🐢 0.86 n=128 |
| `trsv` | 🐰 1.01 | 🐢 0.97 n=4096 | 🐰 1.01 |
| `zgbmvN` | 🐰 1.3 | 🐰 1.22 | 🐰 1.05 |
| `zgemvC` | 🐢 0.96 n=1024 | 🐢 0.91 n=1024 | 🐢 0.93 n=1024 |
| `zgemvN` | 🐢 0.99 n=4096 | 🐢 0.88 n=1024 | 🐢 0.95 n=512 |
| `zgemvT` | 🐢 0.96 n=1024 | 🐢 0.92 n=1024 | 🐢 0.93 n=1024 |
| `zgeru` | 🐢 0.96 n=1024 | 🐢 0.84 n=1024 | 🐢 0.92 n=4096 |
| `zhbmv` | 🐰 1.34 | 🐰 1.05 | 🐰 1.05 |
| `zhemv` | 🐢 0.92 n=2048 | 🐰 1.24 | 🐰 1.39 |
| `zhpmv` | 🐰 1.29 | 🐰 1.12 | 🐰 1.11 |
| `ztrmv` | 🐰 1.05 | 🐰 1.02 | 🐰 1.05 |
| `ztrsv` | 🐰 1.02 | 🐰 1.02 | 🐢 0.94 n=1024 |

#### BLAS-3

| routine | Zen3 · AVX2 | Zen4 · AVX-512 | Zen5 · AVX-512 |
|---|---|---|---|
| `gemm` | 🐢 0.97 n=128 | 🐢 0.97 n=128 | 🐢 1.0 n=256 |
| `symm` | 🐢 0.93 n=256 | 🐢 0.96 n=2048 | 🐢 0.98 n=1024 |
| `syr2k` | 🐢 0.93 n=128 | 🐢 0.96 n=4096 | 🐢 0.95 n=4096 |
| `syrk` | 🐢 0.95 n=128 | 🐢 0.94 n=4096 | 🐢 0.95 n=4096 |
| `trmm` | 🐢 0.89 n=256 | 🐢 0.94 n=1024 | 🐢 0.96 n=1024 |
| `trsm` | 🐢 0.91 n=32 | 🐢 0.91 n=32 | 🐢 0.93 n=32 |
| `trsmR` | 🐢 0.8 n=128 | 🐢 0.95 n=2048 | 🐢 0.94 n=512 |
| `zgemm` | 🐢 0.8 n=32 | 🐢 0.92 n=32 | 🐢 0.95 n=128 |
| `zhemm` | 🐢 0.9 n=32 | 🐢 0.98 n=128 | 🐢 0.98 n=128 |
| `zher2k` | 🐢 0.94 n=128 | 🐢 0.91 n=32 | 🐢 0.99 n=32 |
| `zherk` | 🐢 1.0 n=128 | 🐢 0.98 n=1024 | 🐢 1.0 n=2048 |
| `zsymm` | 🐢 0.89 n=32 | 🐢 0.95 n=512 | 🐢 0.95 n=512 |
| `zsyr2k` | 🐢 0.94 n=128 | 🐢 0.91 n=32 | 🐢 0.96 n=512 |
| `zsyrk` | 🐢 0.99 n=128 | 🐢 0.94 n=128 | 🐢 0.95 n=512 |
| `ztrmm` | 🐢 0.82 n=32 | 🐢 0.93 n=256 | 🐢 0.96 n=256 |
| `ztrmmR` | 🐢 0.78 n=32 | 🐢 0.96 n=512 | 🐢 0.99 n=512 |
| `ztrsm` | 🐢 0.98 n=128 | 🐰 1.07 | 🐰 1.03 |
...
| routine | Zen3 · AVX2 | Zen4 · AVX-512 | Zen5 · AVX-512 |
|---|---|---|---|
| `gbtrf` | 🐢 0.95 n=32 | 🐢 0.73 n=128 | 🐢 0.71 n=128 |
| `gels` | 🐰 1.36 | 🐰 1.29 | 🐰 1.26 |
| `geqp3` | 🐰 1.11 | 🐰 1.02 | 🐰 1.02 |
| `geqrf` | 🐰 1.02 | 🐢 0.96 n=32 | 🐢 0.96 n=32 |
| `gesvd` | 🐰 1.1 | 🐰 1.04 | 🐰 1.06 |
| `getrf` | 🐢 0.96 n=32 | 🐢 0.99 n=32 | 🐢 0.98 n=32 |
| `getrs` | 🐢 0.81 n=8 | 🐢 0.99 n=2048 | 🐢 0.89 n=8 |
| `gtsv` | 🐰 1.2 | 🐰 1.2 | 🐰 1.2 |
| `gttrf` | 🐰 1.51 | 🐰 1.44 | 🐰 1.49 |
| `gttrs` | 🐢 1.0 n=65536 | 🐰 1.0 | 🐢 1.0 n=4096 |
| `pbtrfL` | 🐢 0.98 n=192 | 🐰 1.12 | 🐰 1.06 |
| `pbtrfU` | 🐢 0.87 n=128 | 🐰 1.03 | 🐢 0.97 n=256 |
| `potrf` | 🐰 1.04 | 🐰 1.08 | 🐢 0.98 n=2048 |
| `potrfU` | 🐢 0.82 n=8 | 🐢 0.83 n=8 | 🐢 0.86 n=8 |
| `potrsL` | 🐢 0.95 n=1024 | 🐢 0.91 n=256 | 🐢 0.88 n=512 |
| `potrsU` | 🐢 0.99 n=1024 | 🐢 0.99 n=2048 | 🐰 1.03 |
| `pptrfL` | 🐢 1.0 n=2048 | 🐢 0.91 n=32 | 🐰 1.01 |
| `pptrfU` | 🐰 1.03 | 🐢 0.92 n=128 | 🐢 0.93 n=128 |
| `pstrf` | 🐰 1.02 | 🐢 0.99 n=8 | 🐢 0.84 n=8 |
| `pstrfU` | 🐰 1.01 | 🐢 0.99 n=32 | 🐢 0.94 n=32 |
| `ptsv` | 🐰 1.05 | 🐰 1.05 | 🐰 1.03 |
| `pttrf` | 🐰 1.11 | 🐰 1.12 | 🐰 1.09 |
| `pttrs` | 🐢 0.99 n=256 | 🐢 0.99 n=256 | 🐢 0.99 n=256 |
| `syev` | 🐰 1.18 | 🐰 1.09 | 🐰 1.19 |
| `syevN` | 🐰 1.02 | 🐢 0.98 n=1024 | 🐰 1.08 |
| `sytrf` | 🐰 1.04 | 🐰 1.0 | 🐰 1.06 |
| `sytrs` | 🐰 1.48 | 🐰 1.32 | 🐰 1.36 |
| `trtrs` | 🐰 1.04 | 🐢 0.74 n=2048 | 🐢 0.98 n=2048 |
| `zgeqrf` | 🐰 1.16 | 🐰 1.05 | 🐢 0.97 n=1024 |
| `zgesvd` | 🐰 1.1 | 🐢 0.99 n=32 | 🐰 1.02 |
| `zgetrf` | 🐰 1.01 | 🐢 0.95 n=32 | 🐢 0.95 n=32 |
| `zheev` | 🐰 1.11 | 🐰 1.08 | 🐰 1.05 |
| `zheevN` | 🐢 0.98 n=32 | 🐰 1.05 | 🐰 1.13 |
| `zpotrf` | 🐰 1.01 | 🐢 1.0 n=2048 | 🐰 1.01 |
| `zpotrfU` | 🐢 0.61 n=8 | 🐢 0.61 n=8 | 🐢 0.65 n=8 |
