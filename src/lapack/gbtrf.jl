...
@static if isnothing(_GBTRF_NB_PREF)
    ...
    #
    # kl=125 is Zen3's BINDING cell and nb=16 is best-or-tied on ALL THREE boxes there (+12.7% Zen3,
    ...
    #
    # LEFT ON THE TABLE, measured and deliberately not taken: Zen3 wants nb=24 at kl=64 (+13.0%) and
    # both AVX-512 boxes want nb=16 at kl=256 (+0.5% / +3.1%, and Zen5's 2048 cell is its binding one
    # at 0.994). Neither is taken here because each would move a range where the boxes DISAGREE — Zen3
