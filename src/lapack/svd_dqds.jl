...
function _dlasrt_desc!(A::AbstractVector{Float64}, lo::Int, hi::Int)
    ...
    n <= 1 && return A
    @inbounds begin
        for start in (n ÷ 2):-1:1
            _siftdown!(A, lo, start, n)
        end
        for endi in n:-1:2
...
function _dlasq4(
        Z::Vector{Float64}, i0::Int, n0::Int, pp::Int, n0in::Int, dmin::Float64,
        dmin1::Float64, dmin2::Float64, dn::Float64, dn1::Float64, dn2::Float64,
        tau::Float64, ttype::Int, g::Float64
    )
    cnst1 = 0.563; cnst2 = 1.01; cnst3 = 1.05
    third = 0.333
    if dmin <= 0.0
        return (-dmin, -1, g)
    end
...
function _dlasq3!(
        Z::Vector{Float64}, i0::Int, n0::Int, pp::Int, dmin::Float64, sigma::Float64,
