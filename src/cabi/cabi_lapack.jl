...
for (p, T) in (("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "getrf_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, ipiv::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
...
Base.@ccallable function dgeqrf_64_(
        m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{Float64}, lda::Ptr{Int64},
        tau::Ptr{Float64}, work::Ptr{Float64}, lwork::Ptr{Int64}, info::Ptr{Int64}
    )::Cvoid
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "geqrf_64_"))(
...
Base.@ccallable function sgeqrf_64_(
        m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{Float32}, lda::Ptr{Int64},
        tau::Ptr{Float32}, work::Ptr{Float32}, lwork::Ptr{Int64}, info::Ptr{Int64}
    )::Cvoid
    if unsafe_load(lwork) == Int64(-1)
...
@inline function _qr_vpanel!(dest::AbstractMatrix{T}, Vsrc::AbstractMatrix{T}, i::Int, ib::Int, mp::Int) where {T}
    return @inbounds for c in 1:ib, r in 1:mp
...
@inline function _qr_apply_right!(
        trans::Char, C::AbstractMatrix{Float64}, Vp::AbstractMatrix{Float64},
...
Base.@ccallable function dgeqrt_64_(
        m::Ptr{Int64}, n::Ptr{Int64}, nb::Ptr{Int64}, A::Ptr{Float64},
        lda::Ptr{Int64}, T::Ptr{Float64}, ldt::Ptr{Int64}, work::Ptr{Float64}, info::Ptr{Int64}
    )::Cvoid
    ...
    GC.@preserve τ begin
        ...
        @inbounds for i in 1:k
            t = τ[i]; τ[i] = (isfinite(t) && t != 0.0) ? 1.0 / t : 0.0
        end
...
Base.@ccallable function dgemqrt_64_(
        side::Ptr{UInt8}, trans::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64},
...
@inline function _svd_cabi!(
        ju::Char, jvt::Char, M::Int, N::Int, A::Ptr{Float64}, ld::Int,
    ...
    GC.@preserve ws begin
        ...
        if ju == 'O'                                   # economy U columns overwrite A
            @inbounds for j in 1:mn, i in 1:M
                Av[i, j] = Ut[i, j]
            end
        end
        if jvt == 'O'                                  # economy Vᵀ rows overwrite A
            @inbounds for j in 1:N, i in 1:mn
                Av[i, j] = Vtt[i, j]
            end
        end
    end
...
Base.@ccallable function dgesvd_64_(
        ...
        len_jobu::Clong, len_jobvt::Clong
    )::Cvoid
...
Base.@ccallable function dgesdd_64_(
        jobz::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{Float64},
...
Base.@ccallable function zgesvd_64_(
        jobu::Ptr{UInt8}, jobvt::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64},
        ...
        rwork::Ptr{Float64}, info::Ptr{Int64}, len_jobu::Clong, len_jobvt::Clong
    )::Cvoid
    if unsafe_load(lwork) == Int64(-1)
...
Base.@ccallable function zgesdd_64_(
        jobz::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{ComplexF64},
        ...
        iwork::Ptr{Int64}, info::Ptr{Int64}, len_jobz::Clong
    )::Cvoid
    if unsafe_load(lwork) == Int64(-1)
        unsafe_store!(work, ComplexF64(1)); unsafe_store!(info, Int64(0)); return
    end
...
Base.@ccallable function cgesvd_64_(
        ...
        rwork::Ptr{Float32}, info::Ptr{Int64}, len_jobu::Clong, len_jobvt::Clong
    )::Cvoid
    if unsafe_load(lwork) == Int64(-1)
...
Base.@ccallable function cgesdd_64_(
        jobz::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{ComplexF32},
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval begin
        ...
        Base.@ccallable function $(Symbol(p, "syev_64_"))(
                jobz::Ptr{UInt8}, uplo::Ptr{UInt8}, n::Ptr{Int64},
                A::Ptr{$T}, lda::Ptr{Int64}, w::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64},
                len_jobz::Clong, len_uplo::Clong
            )::Cvoid
            if unsafe_load(lwork) == Int64(-1)                 # workspace query
            ...
            wm = PtrVector(w, N)
            @inbounds for i in eachindex(wm)
                wm[i] = wv[i]
            end
            if jz == 'V'
                Am = PtrMatrix(A, N, N, ld)
        ...
        Base.@ccallable function $(Symbol(p, "syevd_64_"))(
                jobz::Ptr{UInt8}, uplo::Ptr{UInt8}, n::Ptr{Int64},
                A::Ptr{$T}, lda::Ptr{Int64}, w::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64}, iwork::Ptr{Int64},
                liwork::Ptr{Int64}, info::Ptr{Int64}, len_jobz::Clong, len_uplo::Clong
            )::Cvoid
        ...
        Base.@ccallable function $(Symbol(p, "syevr_64_"))(
                jobz::Ptr{UInt8}, range::Ptr{UInt8}, uplo::Ptr{UInt8},
                ...
                info::Ptr{Int64}, len_jobz::Clong, len_range::Clong, len_uplo::Clong
            )::Cvoid
            if unsafe_load(lwork) == Int64(-1)                 # workspace query
                unsafe_store!(work, one($T)); unsafe_store!(iwork, Int64(1)); unsafe_store!(info, Int64(0)); return
            end
            ...
            if wantz && M > 0
                ...
                @inbounds for k in 1:M, i in 1:N
                    Zm[i, k] = Z[i, lo + k - 1]
                end
            end
            ipz = PtrVector(isuppz, 2 * max(M, 0))
            @inbounds for k in 1:M
                ipz[2k - 1] = Int64(1); ipz[2k] = Int64(N)
            end
            unsafe_store!(info, Int64(inf)); return
        end
    end
...
for (p, Tc, Tr) in (("z", ComplexF64, Float64), ("c", ComplexF32, Float32))
    @eval begin
        ...
        Base.@ccallable function $(Symbol(p, "heev_64_"))(
                jobz::Ptr{UInt8}, uplo::Ptr{UInt8}, n::Ptr{Int64},
                A::Ptr{$Tc}, lda::Ptr{Int64}, w::Ptr{$Tr}, work::Ptr{$Tc}, lwork::Ptr{Int64},
                rwork::Ptr{$Tr}, info::Ptr{Int64}, len_jobz::Clong, len_uplo::Clong
            )::Cvoid
        ...
        Base.@ccallable function $(Symbol(p, "heevd_64_"))(
                jobz::Ptr{UInt8}, uplo::Ptr{UInt8}, n::Ptr{Int64},
                A::Ptr{$Tc}, lda::Ptr{Int64}, w::Ptr{$Tr}, work::Ptr{$Tc}, lwork::Ptr{Int64},
                rwork::Ptr{$Tr}, lrwork::Ptr{Int64}, iwork::Ptr{Int64}, liwork::Ptr{Int64},
                info::Ptr{Int64}, len_jobz::Clong, len_uplo::Clong
            )::Cvoid
        ...
        Base.@ccallable function $(Symbol(p, "heevr_64_"))(
                jobz::Ptr{UInt8}, range::Ptr{UInt8}, uplo::Ptr{UInt8},
                ...
                len_jobz::Clong, len_range::Clong, len_uplo::Clong
            )::Cvoid
            if unsafe_load(lwork) == Int64(-1)                 # workspace query (work + rwork + iwork sizes)
                unsafe_store!(work, one($Tc)); unsafe_store!(rwork, one($Tr))
                unsafe_store!(iwork, Int64(1)); unsafe_store!(info, Int64(0)); return
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "trtrs_64_"))(
            uplo::Ptr{UInt8}, trans::Ptr{UInt8},
            diag::Ptr{UInt8}, n::Ptr{Int64}, nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64},
            B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}, lu::Clong, lt::Clong, ld::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "potrs_64_"))(
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "getrs_64_"))(
            trans::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, ipiv::Ptr{Int64}, B::Ptr{$T},
            ldb::Ptr{Int64}, info::Ptr{Int64}, lt::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "getri_64_"))(
            n::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64},
            ipiv::Ptr{Int64}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "potri_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "trtri_64_"))(
            ...
            n::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, info::Ptr{Int64}, lu::Clong, ld::Clong
        )::Cvoid
...
@inline function _qr_t_cmplx!(
        Tm::AbstractMatrix{T}, Vp::AbstractMatrix{T}, tau::AbstractVector{T},
        G::AbstractMatrix{T}
    ) where {T <: Complex}
...
@inline function _qr_apply_left_cmplx!(
        trans::Char, C::AbstractMatrix{T}, Vp::AbstractMatrix{T},
        Tblk::AbstractMatrix{T}
    ) where {T <: Complex}
...
@inline function _qr_apply_right_cmplx!(
        trans::Char, C::AbstractMatrix{T}, Vp::AbstractMatrix{T},
        Tblk::AbstractMatrix{T}
    ) where {T <: Complex}
    nr = size(C, 1); ib = size(Vp, 2)
...
for (p, T) in (("z", ComplexF64), ("c", ComplexF32))
    @eval Base.@ccallable function $(Symbol(p, "geqrt_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, nb::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, T::Ptr{$T}, ldt::Ptr{Int64}, work::Ptr{$T}, info::Ptr{Int64}
        )::Cvoid
        M = Int(unsafe_load(m)); N = Int(unsafe_load(n)); NB = Int(unsafe_load(nb)); k = min(M, N)
        Av = PtrMatrix(A, M, N, Int(unsafe_load(lda)))
        Tm = PtrMatrix(T, NB, k, Int(unsafe_load(ldt)))
    ...
    @eval Base.@ccallable function $(Symbol(p, "gemqrt_64_"))(
...
@inline function _f32_to_f64!(dst::Matrix{Float64}, src::PtrMatrix{Float32}, M::Int, N::Int)
    return @inbounds for j in 1:N, i in 1:M
...
Base.@ccallable function sgetrf_64_(
        m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{Float32}, lda::Ptr{Int64},
        ipiv::Ptr{Int64}, info::Ptr{Int64}
    )::Cvoid
...
Base.@ccallable function sgeqrt_64_(
        m::Ptr{Int64}, n::Ptr{Int64}, nb::Ptr{Int64}, A::Ptr{Float32},
        lda::Ptr{Int64}, T::Ptr{Float32}, ldt::Ptr{Int64}, work::Ptr{Float32}, info::Ptr{Int64}
    )::Cvoid
    M = Int(unsafe_load(m)); N = Int(unsafe_load(n)); NB = Int(unsafe_load(nb)); k = min(M, N)
...
Base.@ccallable function sgemqrt_64_(
        side::Ptr{UInt8}, trans::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64},
...
@inline function _svd_cabi_f32!(
        ju::Char, jvt::Char, M::Int, N::Int, A::Ptr{Float32}, ld::Int,
...
Base.@ccallable function sgesvd_64_(
        jobu::Ptr{UInt8}, jobvt::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64},
...
Base.@ccallable function sgesdd_64_(
        jobz::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{Float32},
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gelqf_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, tau::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
...
for (nm, T) in (("sorglq", Float32), ("dorglq", Float64), ("cunglq", ComplexF32), ("zunglq", ComplexF64))
    @eval Base.@ccallable function $(Symbol(nm, "_64_"))(
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "sytrf_64_"))(
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "hetrf_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, ipiv::Ptr{Int64}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64},
            lu::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "sytrs_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, ipiv::Ptr{Int64}, B::Ptr{$T},
            ldb::Ptr{Int64}, info::Ptr{Int64}, lu::Clong
        )::Cvoid
        N = Int(unsafe_load(n)); R = Int(unsafe_load(nrhs))
        sytrs!(
            PtrMatrix(A, N, N, Int(unsafe_load(lda))), PtrVector(ipiv, N),
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "hetrs_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, ipiv::Ptr{Int64}, B::Ptr{$T},
            ldb::Ptr{Int64}, info::Ptr{Int64}, lu::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "geqp3_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{$T},
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gels_64_"))(
            trans::Ptr{UInt8}, m::Ptr{Int64},
            n::Ptr{Int64}, nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64},
            work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}, lt::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T, Tr, IW) in (
        ("s", Float32, Float32, Int64), ("d", Float64, Float64, Int64),
        ("c", ComplexF32, Float32, Float32), ("z", ComplexF64, Float64, Float64),
    )
    @eval Base.@ccallable function $(Symbol(p, "gecon_64_"))(
            normtype::Ptr{UInt8}, n::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, anorm::Ptr{$Tr}, rcond::Ptr{$Tr}, work::Ptr{$T},
            iwork::Ptr{$IW}, info::Ptr{Int64}, ln::Clong
        )::Cvoid
        N = Int(unsafe_load(n))
        Am = PtrMatrix(A, N, N, Int(unsafe_load(lda)))
...
for (p, T, Tr, IW) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "trcon_64_"))(
            norm::Ptr{UInt8}, uplo::Ptr{UInt8},
            diag::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, rcond::Ptr{$Tr}, work::Ptr{$T},
            iwork::Ptr{$IW}, info::Ptr{Int64}, ln::Clong, lu::Clong, ld::Clong
        )::Cvoid
        N = Int(unsafe_load(n))
        Am = PtrMatrix(A, N, N, Int(unsafe_load(lda)))
...
for (p, T, Tr, IW) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "pocon_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T},
...
for (p, T, Tr) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "gebal_64_"))(
            job::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T},
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gehrd_64_"))(
            n::Ptr{Int64}, ilo::Ptr{Int64},
...
for (nm, T) in (("sorghr", Float32), ("dorghr", Float64), ("cunghr", ComplexF32), ("zunghr", ComplexF64))
    @eval Base.@ccallable function $(Symbol(nm, "_64_"))(
            n::Ptr{Int64}, ilo::Ptr{Int64}, ihi::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, tau::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64},
            info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "geev_64_"))(
            jobvl::Ptr{UInt8}, jobvr::Ptr{UInt8},
            ...
            info::Ptr{Int64}, ljl::Clong, ljr::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "geevx_64_"))(
            balanc::Ptr{UInt8}, jobvl::Ptr{UInt8},
            ...
            lb::Clong, ljl::Clong, ljr::Clong, ls::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
        ...
        scp = PtrVector(scale, N); @inbounds for i in 1:N
            scp[i] = scl[i]
        end
...
for (p, T, R) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64))
    @eval Base.@ccallable function $(Symbol(p, "geevx_64_"))(
        ...
        wp = PtrVector(w, N); @inbounds for i in 1:N
            wp[i] = wa[i]
        end
        if jr == 'V'
            VRp = PtrMatrix(vr, N, N, Int(unsafe_load(ldvr)))
...
# info, +2 lens).
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "gees_64_"))(
            jobvs::Ptr{UInt8}, sort::Ptr{UInt8},
            ...
            bwork::Ptr{Cvoid}, info::Ptr{Int64}, ljvs::Clong, ls::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T, R) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64))
    @eval Base.@ccallable function $(Symbol(p, "gees_64_"))(
            ...
            rwork::Ptr{$R}, bwork::Ptr{Cvoid}, info::Ptr{Int64}, ljvs::Clong, ls::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "sygvd_64_"))(
            itype::Ptr{Int64}, jobz::Ptr{UInt8},
            ...
            info::Ptr{Int64}, l_jobz::Clong, l_uplo::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(iwork, Int64(1)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, Tc, Tr) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64))
    @eval Base.@ccallable function $(Symbol(p, "hegvd_64_"))(
            itype::Ptr{Int64}, jobz::Ptr{UInt8},
            ...
            iwork::Ptr{Int64}, liwork::Ptr{Int64}, info::Ptr{Int64}, l_jobz::Clong, l_uplo::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($Tc)); unsafe_store!(rwork, one($Tr))
            unsafe_store!(iwork, Int64(1)); unsafe_store!(info, Int64(0)); return
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gtsv_64_"))(
            n::Ptr{Int64}, nrhs::Ptr{Int64},
            dl::Ptr{$T}, d::Ptr{$T}, du::Ptr{$T}, B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        N = Int(unsafe_load(n)); R = Int(unsafe_load(nrhs))
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gttrf_64_"))(
            n::Ptr{Int64}, dl::Ptr{$T}, d::Ptr{$T},
            du::Ptr{$T}, du2::Ptr{$T}, ipiv::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        N = Int(unsafe_load(n))
        dlv = PtrVector(dl, max(N - 1, 0)); dv = PtrVector(d, N); duv = PtrVector(du, max(N - 1, 0))
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gttrs_64_"))(
            trans::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, dl::Ptr{$T}, d::Ptr{$T}, du::Ptr{$T}, du2::Ptr{$T}, ipiv::Ptr{Int64},
            B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}, l_trans::Clong
        )::Cvoid
        N = Int(unsafe_load(n)); R = Int(unsafe_load(nrhs))
        dlv = PtrVector(dl, max(N - 1, 0)); dv = PtrVector(d, N); duv = PtrVector(du, max(N - 1, 0))
        du2v = PtrVector(du2, max(N - 2, 0)); ipv = PtrVector(ipiv, N)
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "stev_64_"))(
            job::Ptr{UInt8}, n::Ptr{Int64}, dv::Ptr{$T},
            ev::Ptr{$T}, Z::Ptr{$T}, ldz::Ptr{Int64}, work::Ptr{$T}, info::Ptr{Int64}, l_job::Clong
        )::Cvoid
        ...
        if jb == 'V'
            ...
            Zw = zeros($T, N, N); @inbounds for i in 1:N
                Zw[i, i] = one($T)
            end   # I (steqr('I') skips init at n=1)
            _steqr!('I', d, e, Zw)
            @inbounds for j in 1:N, i in 1:N
                Zm[i, j] = Zw[i, j]
            end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "stegr_64_"))(
            jobz::Ptr{UInt8}, range::Ptr{UInt8},
            n::Ptr{Int64}, dv::Ptr{$T}, ev::Ptr{$T}, vl::Ptr{$T}, vu::Ptr{$T}, il::Ptr{Int64},
            iu::Ptr{Int64}, abstol::Ptr{$T}, m::Ptr{Int64}, w::Ptr{$T}, Z::Ptr{$T}, ldz::Ptr{Int64},
            isuppz::Ptr{Int64}, work::Ptr{$T}, lwork::Ptr{Int64}, iwork::Ptr{Int64}, liwork::Ptr{Int64},
            info::Ptr{Int64}, l_jobz::Clong, l_range::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(iwork, Int64(1)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "pbtrf_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            kd::Ptr{Int64}, AB::Ptr{$T}, ldab::Ptr{Int64}, info::Ptr{Int64}, l_uplo::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "pbtrs_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            kd::Ptr{Int64}, nrhs::Ptr{Int64}, AB::Ptr{$T}, ldab::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64},
            info::Ptr{Int64}, l_uplo::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "pptrf_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            AP::Ptr{$T}, info::Ptr{Int64}, l_uplo::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "pptrs_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, AP::Ptr{$T}, B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}, l_uplo::Clong
        )::Cvoid
...
@inline function _ggev_cabi_real!(
        ::Type{T}, jl::Char, jr::Char, N::Int, A::Ptr{T}, lda::Int,
    ...
    @inbounds for i in 1:N
        arp[i] = arr[i]; aip[i] = aii[i]; bep[i] = bee[i]
    end
    if jr == 'V'
...
@inline function _ggev_cabi_cmplx!(
        ::Type{T}, ::Type{R}, jl::Char, jr::Char, N::Int, A::Ptr{T}, lda::Int,
        B::Ptr{T}, ldb::Int, alpha::Ptr{T}, beta::Ptr{T}, vr::Ptr{T}, ldvr::Int, info::Ptr{Int64}
    ) where {T <: Complex, R}
    if jl != 'N'
        unsafe_store!(info, Int64(-1)); return
    end
...
for (p, T) in (("s", Float32), ("d", Float64)), nm in ("ggev", "ggev3")
    @eval Base.@ccallable function $(Symbol(p, nm, "_64_"))(
            jobvl::Ptr{UInt8}, jobvr::Ptr{UInt8},
            ...
            work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}, ljl::Clong, ljr::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
        _ggev_cabi_real!(
            $T, _cabi_char(jobvl), _cabi_char(jobvr), Int(unsafe_load(n)), A,
...
for (p, T, R) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64)), nm in ("ggev", "ggev3")
    @eval Base.@ccallable function $(Symbol(p, nm, "_64_"))(
            ...
            lwork::Ptr{Int64}, rwork::Ptr{$R}, info::Ptr{Int64}, ljl::Clong, ljr::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
        _ggev_cabi_cmplx!(
            $T, $R, _cabi_char(jobvl), _cabi_char(jobvr), Int(unsafe_load(n)), A,
...
@inline function _gges_cabi_real!(
        ::Type{T}, jvsl::Char, jvsr::Char, N::Int, A::Ptr{T}, lda::Int,
        B::Ptr{T}, ldb::Int, alphar::Ptr{T}, alphai::Ptr{T}, beta::Ptr{T}, vsl::Ptr{T}, ldvsl::Int,
        vsr::Ptr{T}, ldvsr::Int, sdim::Ptr{Int64}, info::Ptr{Int64}
    ) where {T <: Real}
    Am = PtrMatrix(A, N, N, lda); Bm = PtrMatrix(B, N, N, ldb)
    _, _, alC, bee, VSL, VSR = _gges_run!(Am, Bm)
    arp = PtrVector(alphar, N); aip = PtrVector(alphai, N); bep = PtrVector(beta, N)
    @inbounds for i in 1:N
        arp[i] = real(alC[i]); aip[i] = imag(alC[i]); bep[i] = bee[i]
    end
    if jvsl == 'V'
        m = PtrMatrix(vsl, N, N, ldvsl); @inbounds for j in 1:N, i in 1:N
            m[i, j] = VSL[i, j]
        end
    end
    if jvsr == 'V'
        m = PtrMatrix(vsr, N, N, ldvsr); @inbounds for j in 1:N, i in 1:N
            m[i, j] = VSR[i, j]
        end
    end
    unsafe_store!(sdim, Int64(0)); unsafe_store!(info, Int64(0)); return
end
@inline function _gges_cabi_cmplx!(
        ::Type{T}, jvsl::Char, jvsr::Char, N::Int, A::Ptr{T}, lda::Int,
        B::Ptr{T}, ldb::Int, alpha::Ptr{T}, beta::Ptr{T}, vsl::Ptr{T}, ldvsl::Int, vsr::Ptr{T},
        ldvsr::Int, sdim::Ptr{Int64}, info::Ptr{Int64}
    ) where {T <: Complex}
    Am = PtrMatrix(A, N, N, lda); Bm = PtrMatrix(B, N, N, ldb)
...
for (p, T) in (("s", Float32), ("d", Float64)), nm in ("gges", "gges3")
    @eval Base.@ccallable function $(Symbol(p, nm, "_64_"))(
            jobvsl::Ptr{UInt8}, jobvsr::Ptr{UInt8},
            ...
            lwork::Ptr{Int64}, bwork::Ptr{Cvoid}, info::Ptr{Int64}, ljl::Clong, ljr::Clong, ls::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
        _gges_cabi_real!(
            $T, _cabi_char(jobvsl), _cabi_char(jobvsr), Int(unsafe_load(n)), A,
...
for (p, T, R) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64)), nm in ("gges", "gges3")
    @eval Base.@ccallable function $(Symbol(p, nm, "_64_"))(
            ...
            rwork::Ptr{$R}, bwork::Ptr{Cvoid}, info::Ptr{Int64}, ljl::Clong, ljr::Clong, ls::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gbtrf_64_"))(
            ...
            ku::Ptr{Int64}, AB::Ptr{$T}, ldab::Ptr{Int64}, ipiv::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gbtrs_64_"))(
            trans::Ptr{UInt8}, n::Ptr{Int64},
            kl::Ptr{Int64}, ku::Ptr{Int64}, nrhs::Ptr{Int64}, AB::Ptr{$T}, ldab::Ptr{Int64},
            ipiv::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}, lt::Clong
        )::Cvoid
...
for (p, T, Tr) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "ptsv_64_"))(
            n::Ptr{Int64}, nrhs::Ptr{Int64}, D::Ptr{$Tr},
            E::Ptr{$T}, B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        N = Int(unsafe_load(n)); R = Int(unsafe_load(nrhs))
...
for (p, T, Tr) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "pttrf_64_"))(
            n::Ptr{Int64}, D::Ptr{$Tr}, E::Ptr{$T},
            info::Ptr{Int64}
        )::Cvoid
        N = Int(unsafe_load(n))
        Dv = PtrVector(D, N); Ev = PtrVector(E, max(N - 1, 0))
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "pttrs_64_"))(
            n::Ptr{Int64}, nrhs::Ptr{Int64}, D::Ptr{$T},
            E::Ptr{$T}, B::Ptr{$T}, ldb::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        N = Int(unsafe_load(n)); R = Int(unsafe_load(nrhs))
        Dv = PtrVector(D, N); Ev = PtrVector(E, max(N - 1, 0))
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "stebz_64_"))(
            range::Ptr{UInt8}, order::Ptr{UInt8},
        ...
        wv, ibv, isv, inf = stebz!(
            _cabi_char(range), _cabi_char(order), unsafe_load(vl), unsafe_load(vu),
            Int(unsafe_load(il)), Int(unsafe_load(iu)), unsafe_load(abstol), dv_, ev_
        )
        M = length(wv)
        wm = PtrVector(w, N); ibm = PtrVector(iblock, N)
        @inbounds for i in 1:M
            wm[i] = wv[i]; ibm[i] = Int64(ibv[i])
        end
        NS = length(isv)
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "stein_64_"))(
            n::Ptr{Int64}, dv::Ptr{$T}, ev::Ptr{$T},
            m::Ptr{Int64}, w::Ptr{$T}, iblock::Ptr{Int64}, isplit::Ptr{Int64}, z::Ptr{$T}, ldz::Ptr{Int64},
            work::Ptr{$T}, iwork::Ptr{Int64}, ifail::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        N = Int(unsafe_load(n)); M = Int(unsafe_load(m))
        dv_ = PtrVector(dv, N); ev_ = PtrVector(ev, max(N - 1, 0))
        wv = Vector{$T}(undef, M); @inbounds for i in 1:M
            wv[i] = unsafe_load(w, i)
        end
        ...
        ifp = PtrVector(ifail, max(M, 1)); @inbounds for i in 1:M
            ifp[i] = Int64(0)
        end
        unsafe_store!(info, Int64(0)); return
    end
...
for (p, T, Tr) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "pstrf_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T},
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "geqlf_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, tau::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gerqf_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, tau::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "tzrzf_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, tau::Ptr{$T}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
...
for (nm, T) in (("sormrz", Float32), ("dormrz", Float64), ("cunmrz", ComplexF32), ("zunmrz", ComplexF64))
    @eval Base.@ccallable function $(Symbol(nm, "_64_"))(
            ...
            info::Ptr{Int64}, len_s::Clong, len_t::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "gelsy_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, nrhs::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64}, jpvt::Ptr{Int64}, rcond::Ptr{$T},
            rank::Ptr{Int64}, work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T, R) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64))
    @eval Base.@ccallable function $(Symbol(p, "gelsy_64_"))(
            ...
            rank::Ptr{Int64}, work::Ptr{$T}, lwork::Ptr{Int64}, rwork::Ptr{$R}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "gelsd_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, nrhs::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64}, S::Ptr{$T}, rcond::Ptr{$T},
            rank::Ptr{Int64}, work::Ptr{$T}, lwork::Ptr{Int64}, iwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(iwork, Int64(1)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "sysv_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, ipiv::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64},
            work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}, lu::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "hesv_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64},
            nrhs::Ptr{Int64}, A::Ptr{$T}, lda::Ptr{Int64}, ipiv::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64},
            work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}, lu::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "sytri_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, ipiv::Ptr{Int64}, work::Ptr{$T}, info::Ptr{Int64}, lu::Clong
        )::Cvoid
        N = Int(unsafe_load(n))
        Am = PtrMatrix(A, N, N, Int(unsafe_load(lda)))
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "hetri_64_"))(
            uplo::Ptr{UInt8}, n::Ptr{Int64}, A::Ptr{$T},
            lda::Ptr{Int64}, ipiv::Ptr{Int64}, work::Ptr{$T}, info::Ptr{Int64}, lu::Clong
        )::Cvoid
        N = Int(unsafe_load(n))
...
for (p, T, Tr) in (
    ...
    @eval Base.@ccallable function $(Symbol(p, "trsyl_64_"))(
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "trexc_64_"))(
            compq::Ptr{UInt8}, n::Ptr{Int64},
            Tm_::Ptr{$T}, ldt::Ptr{Int64}, Q::Ptr{$T}, ldq::Ptr{Int64}, ifst::Ptr{Int64}, ilst::Ptr{Int64},
            work::Ptr{$T}, info::Ptr{Int64}, lc::Clong
        )::Cvoid
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "trsen_64_"))(
            job::Ptr{UInt8}, compq::Ptr{UInt8},
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval Base.@ccallable function $(Symbol(p, "gglse_64_"))(
            m::Ptr{Int64}, n::Ptr{Int64}, pp::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64}, cc::Ptr{$T}, dd::Ptr{$T}, X::Ptr{$T},
            work::Ptr{$T}, lwork::Ptr{Int64}, info::Ptr{Int64}
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
        ...
        Xv = PtrVector(X, N); @inbounds for i in 1:N
            Xv[i] = x[i]
        end
        unsafe_store!(info, Int64(0)); return
    end
...
@inline function _ggsvd_cabi!(
        ::Type{T}, ::Type{Tr}, ju::Char, jv::Char, jq::Char, M::Int, N::Int, P::Int,
    ...
    if ju == 'U'
        Um = PtrMatrix(U, M, M, ldu); @inbounds for j in 1:M, i in 1:M
            Um[i, j] = Uo[i, j]
        end
    end
    if jv == 'V'
        Vm = PtrMatrix(V, P, P, ldv); @inbounds for j in 1:P, i in 1:P
            Vm[i, j] = Vo[i, j]
        end
    end
    if jq == 'Q'
        Qm = PtrMatrix(Q, N, N, ldq); @inbounds for j in 1:N, i in 1:N
            Qm[i, j] = Qo[i, j]
        end
    end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval Base.@ccallable function $(Symbol(p, "ggsvd_64_"))(
            jobu::Ptr{UInt8}, jobv::Ptr{UInt8},
            ...
            work::Ptr{$T}, iwork::Ptr{Int64}, info::Ptr{Int64}, lju::Clong, ljv::Clong, ljq::Clong
        )::Cvoid
        _ggsvd_cabi!(
            $T, $T, _cabi_char(jobu), _cabi_char(jobv), _cabi_char(jobq), Int(unsafe_load(m)),
    ...
    @eval Base.@ccallable function $(Symbol(p, "ggsvd3_64_"))(
            jobu::Ptr{UInt8}, jobv::Ptr{UInt8},
            jobq::Ptr{UInt8}, m::Ptr{Int64}, n::Ptr{Int64}, pp::Ptr{Int64}, k::Ptr{Int64}, l::Ptr{Int64},
            A::Ptr{$T}, lda::Ptr{Int64}, B::Ptr{$T}, ldb::Ptr{Int64}, alpha::Ptr{$T}, beta::Ptr{$T},
            U::Ptr{$T}, ldu::Ptr{Int64}, V::Ptr{$T}, ldv::Ptr{Int64}, Q::Ptr{$T}, ldq::Ptr{Int64},
            work::Ptr{$T}, lwork::Ptr{Int64}, iwork::Ptr{Int64}, info::Ptr{Int64},
            lju::Clong, ljv::Clong, ljq::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
...
for (p, T, Tr) in (("c", ComplexF32, Float32), ("z", ComplexF64, Float64))
    @eval Base.@ccallable function $(Symbol(p, "ggsvd_64_"))(
        ...
        _ggsvd_cabi!(
            $T, $Tr, _cabi_char(jobu), _cabi_char(jobv), _cabi_char(jobq), Int(unsafe_load(m)),
            Int(unsafe_load(n)), Int(unsafe_load(pp)), A, Int(unsafe_load(lda)), B, Int(unsafe_load(ldb)),
            alpha, beta, U, Int(unsafe_load(ldu)), V, Int(unsafe_load(ldv)), Q, Int(unsafe_load(ldq)),
            k, l, info
        )
    ...
    @eval Base.@ccallable function $(Symbol(p, "ggsvd3_64_"))(
            ...
            info::Ptr{Int64}, lju::Clong, ljv::Clong, ljq::Clong
        )::Cvoid
        if unsafe_load(lwork) == Int64(-1)
            unsafe_store!(work, one($T)); unsafe_store!(info, Int64(0)); return
        end
