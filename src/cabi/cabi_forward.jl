...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval begin
        _reg!(
            $(p * "axpy_"), () -> @cfunction(
                $(Symbol(p, "axpy_64_")), Cvoid,
                (_CI, Ptr{$T}, Ptr{$T}, _CI, Ptr{$T}, _CI)
            )
        )
        _reg!(
            $(p * "scal_"), () -> @cfunction(
                $(Symbol(p, "scal_64_")), Cvoid,
                (_CI, Ptr{$T}, Ptr{$T}, _CI)
            )
        )
        _reg!(
            $(p * "copy_"), () -> @cfunction(
                $(Symbol(p, "copy_64_")), Cvoid,
                (_CI, Ptr{$T}, _CI, Ptr{$T}, _CI)
            )
        )
        _reg!(
            $(p * "swap_"), () -> @cfunction(
                $(Symbol(p, "swap_64_")), Cvoid,
                (_CI, Ptr{$T}, _CI, Ptr{$T}, _CI)
            )
        )
    end
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval _reg!(
        $(p * "gemv_"), () -> @cfunction(
            $(Symbol(p, "gemv_64_")), Cvoid,
            (_CU, _CI, _CI, Ptr{$T}, Ptr{$T}, _CI, Ptr{$T}, _CI, Ptr{$T}, Ptr{$T}, _CI, Clong)
        )
    )
end
for (nm, T) in (
        ("sger", Float32), ("dger", Float64), ("cgeru", ComplexF32), ("zgeru", ComplexF64),
        ("cgerc", ComplexF32), ("zgerc", ComplexF64),
    )
    @eval _reg!(
        $(nm * "_"), () -> @cfunction(
            $(Symbol(nm, "_64_")), Cvoid,
...
for (nm, T, AT) in (
        ("sspr", Float32, Float32), ("dspr", Float64, Float64),
...
# ─────────────────────────────── BLAS-3 (cabi_l3.jl) ─────────────────────────────────────────────
for (nm, T) in (
        ("ssymm", Float32), ("dsymm", Float64), ("csymm", ComplexF32), ("zsymm", ComplexF64),
...
for (nm, T, ST) in (
        ("ssyrk", Float32, Float32), ("dsyrk", Float64, Float64),
...
for (nm, T, ST) in (
        ("ssyr2k", Float32, Float32), ("dsyr2k", Float64, Float64),
...
for (p, T) in (("z", ComplexF64), ("c", ComplexF32))
    @eval _reg!(
        $(p * "geqrt_"), () -> @cfunction(
            $(Symbol(p, "geqrt_64_")), Cvoid,
            (_CI, _CI, _CI, Ptr{$T}, _CI, Ptr{$T}, _CI, Ptr{$T}, _CI)
        )
    )
    @eval _reg!(
        $(p * "gemqrt_"), () -> @cfunction(
            $(Symbol(p, "gemqrt_64_")), Cvoid,
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval begin
        _reg!(
            $(p * "sytrf_"), () -> @cfunction(
                $(Symbol(p, "sytrf_64_")), Cvoid,
                (_CU, _CI, Ptr{$T}, _CI, _CI, Ptr{$T}, _CI, _CI, Clong)
            )
        )
        _reg!(
            $(p * "sytrs_"), () -> @cfunction(
                $(Symbol(p, "sytrs_64_")), Cvoid,
                (_CU, _CI, _CI, Ptr{$T}, _CI, _CI, Ptr{$T}, _CI, _CI, Clong)
            )
        )
    end
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))     # hetrf/hetrs complex only
    @eval begin
        _reg!(
            $(p * "hetrf_"), () -> @cfunction(
                $(Symbol(p, "hetrf_64_")), Cvoid,
                (_CU, _CI, Ptr{$T}, _CI, _CI, Ptr{$T}, _CI, _CI, Clong)
            )
        )
        _reg!(
            $(p * "hetrs_"), () -> @cfunction(
                $(Symbol(p, "hetrs_64_")), Cvoid,
                (_CU, _CI, _CI, Ptr{$T}, _CI, _CI, Ptr{$T}, _CI, _CI, Clong)
            )
        )
    end
...
for (p, T) in (("s", Float32), ("d", Float64))
    @eval begin
        _reg!(
            $(p * "stev_"), () -> @cfunction(
                $(Symbol(p, "stev_64_")), Cvoid,
                (_CU, _CI, Ptr{$T}, Ptr{$T}, Ptr{$T}, _CI, Ptr{$T}, _CI, Clong)
            )
        )
        _reg!(
            $(p * "stegr_"), () -> @cfunction(
                $(Symbol(p, "stegr_64_")), Cvoid,
                (
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval begin
        _reg!(
            $(p * "gbtrf_"), () -> @cfunction(
                $(Symbol(p, "gbtrf_64_")), Cvoid,
                (_CI, _CI, _CI, _CI, Ptr{$T}, _CI, Ptr{Int64}, _CI)
            )
        )
        _reg!(
            $(p * "gbtrs_"), () -> @cfunction(
                $(Symbol(p, "gbtrs_64_")), Cvoid,
...
for (p, T, Tr) in (
    ...
    @eval begin
        _reg!(
            $(p * "ptsv_"), () -> @cfunction(
                $(Symbol(p, "ptsv_64_")), Cvoid,
                (_CI, _CI, Ptr{$Tr}, Ptr{$T}, Ptr{$T}, _CI, _CI)
            )
        )
        _reg!(
            $(p * "pttrf_"), () -> @cfunction(
                $(Symbol(p, "pttrf_64_")), Cvoid,
...
for (p, T) in (("s", Float32), ("d", Float64), ("c", ComplexF32), ("z", ComplexF64))
    @eval begin
        _reg!(
            $(p * "geqlf_"), () -> @cfunction(
                $(Symbol(p, "geqlf_64_")), Cvoid,
                (_CI, _CI, Ptr{$T}, _CI, Ptr{$T}, Ptr{$T}, _CI, _CI)
            )
        )
        _reg!(
            $(p * "gerqf_"), () -> @cfunction(
                $(Symbol(p, "gerqf_64_")), Cvoid,
                (_CI, _CI, Ptr{$T}, _CI, Ptr{$T}, Ptr{$T}, _CI, _CI)
            )
        )
    end
...
for (p, T) in (("c", ComplexF32), ("z", ComplexF64))
    @eval begin
        _reg!(
            $(p * "hesv_"), () -> @cfunction(
                $(Symbol(p, "hesv_64_")), Cvoid,
                (_CU, _CI, _CI, Ptr{$T}, _CI, Ptr{Int64}, Ptr{$T}, _CI, Ptr{$T}, _CI, _CI, Clong)
            )
        )
        _reg!(
            $(p * "hetri_"), () -> @cfunction(
                $(Symbol(p, "hetri_64_")), Cvoid,
                (_CU, _CI, Ptr{$T}, _CI, Ptr{Int64}, Ptr{$T}, _CI, Clong)
            )
        )
    end
