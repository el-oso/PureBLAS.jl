...
function _gvd_impl!(itype::Integer, jobz::Char, uplo::Char,
...
function sygvd!(itype::Integer, jobz::Char, uplo::Char,
        A::AbstractMatrix{T}, B::AbstractMatrix{T}) where {T<:Real}
    return _gvd_impl!(itype, jobz, uplo, A, B)
end

function hegvd!(itype::Integer, jobz::Char, uplo::Char,
        A::AbstractMatrix{T}, B::AbstractMatrix{T}) where {T<:Complex}
    return _gvd_impl!(itype, jobz, uplo, A, B)
end
