...
@testitem "TrimCheck trim-safety (C-ABI entry points)" tags = [:checks] begin
    ...
    @validate(
        ...
        PureBLAS.zsyrk_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64}, Ptr{ComplexF64}, Ptr{ComplexF64},
            Ptr{Int64}, Ptr{ComplexF64}, Ptr{ComplexF64}, Ptr{Int64}, Clong, Clong
        ),
        PureBLAS.zherk_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64}, Ptr{Float64}, Ptr{ComplexF64},
            Ptr{Int64}, Ptr{Float64}, Ptr{ComplexF64}, Ptr{Int64}, Clong, Clong
        ),
        PureBLAS.csyrk_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64}, Ptr{ComplexF32}, Ptr{ComplexF32},
            Ptr{Int64}, Ptr{ComplexF32}, Ptr{ComplexF32}, Ptr{Int64}, Clong, Clong
        ),
        PureBLAS.cherk_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64}, Ptr{Float32}, Ptr{ComplexF32},
        ...
        PureBLAS.ztrsm_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64},
        ...
        PureBLAS.dgesvd_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64}, Ptr{Float64}, Ptr{Int64},
        ...
        PureBLAS.dormlq_64_(
            Ptr{UInt8}, Ptr{UInt8}, Ptr{Int64}, Ptr{Int64}, Ptr{Int64}, Ptr{Float64}, Ptr{Int64},
